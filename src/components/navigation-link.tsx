...
export function NavigationLink({ label, icon: Icon, href, active }: Readonly<{
  ...
  const activeClasses = pathname.startsWith(href) || active ? "bg-illuminating-emerald-200 text-illuminating-emerald-800" : "hover:bg-zinc-300 dark:hover:bg-zinc-700";
