...
export function NavigationLink({ label, icon: Icon, href, active, onClick }: Readonly<{
  ...
  const activeClasses = isLinkActive(pathname, href, active) ? "bg-illuminating-emerald-100 text-illuminating-emerald-800" : "hover:bg-zinc-300 dark:hover:bg-zinc-700";
